        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.product.update', [$product->produto_id]) }}" method="post"
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" name="categoria_id">
                                            @foreach ($categories as $categorie)
                                                <option value="{{ $categorie->categoria_id }}" {{ $categorie->categoria_id == $product->categoria_id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                placeholder="Enter email" name="nome" value="{{ $product->nome }}">
                                        </div>
                                        @if ($errors->has('nome'))
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="exampleInputEmail1"
                                                placeholder="" name="preco" value="{{ $product->preco }}">
                                        </div>
                                        @if ($errors->has('preco'))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="exampleInputEmail1"
                                                placeholder="" name="quantidade" value="{{ $product->quantidade }}">
                                        </div>
